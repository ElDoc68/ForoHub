...
public class TokenService {
    ...
    public String getSubject(String token){
        ...
        try {
            ...
            if (username == null) {
                throw new IllegalArgumentException("Disculpe token no válido: Asunto no encontrado");
            }
            Usuario usuario = (Usuario) usuarioRepository.findByEmail(username);
            if (usuario == null) {
                throw new IllegalArgumentException("Disculpe usuario no encontrado por nombre de usuario: " + username);
            }
            ...
            throw new IllegalArgumentException("Disculpe token no válido: " + e.getMessage(), e);
        }
    }
