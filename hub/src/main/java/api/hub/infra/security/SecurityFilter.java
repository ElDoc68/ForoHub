            ...
            if (authHeader != null && authHeader.startsWith("Bearer ")) {
                ...
                if (subject != null) {
                    ...
                    if (usuario != null) {
                        ...
                        throw new IllegalArgumentException("Disculpe usuario no encontrado por nombre de usuario: " + subject);
                    }
                }
            }
        } catch (IllegalArgumentException e) {
            logger.error("Disculpe error de autentificación: " + e.getMessage(), e);
        }
